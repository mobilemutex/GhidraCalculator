...
public class MarkScalarAction extends ListingContextAction {
    protected final CalculatorPlugin plugin;
    private final int operandIndex;

    public MarkScalarAction(CalculatorPlugin plugin, String actionName, int operandIndex, String groupName) {
    ...
    public boolean isEnabledForContext(ListingActionContext context) {
        ...
        for (Object obj : opObjects) {
            if (obj instanceof Scalar) {
                String menuName = "Mark Scalar Value: " + 
